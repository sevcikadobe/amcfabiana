...
<section class="white-wrapper clearfix padding-top padding-bottom">
			...
			<div id="content" class="shop_wrapper<?php echo esc_attr($classes); ?> col-sm-12 col-xs-12 woocommerce">
					...
					<div class="single-page">
						<table class="cart_table table table-hover">
							...
							<thead style="text-align:center;">
								<tr>
									<th><?php esc_html_e('PRODUCT', 'furniture'); ?></th>
									<th><?php esc_html_e('PRICE', 'furniture'); ?></th>
									<th><?php esc_html_e('ACTION', 'furniture'); ?></th>
                                    <th><?php esc_html_e('DELETE', 'furniture'); ?></th>
								</tr>
							</thead>
								...
								<tbody>
									<tr>
										...
										<td class="wishlist_delete">
											<a class="remove" rel="product_del_wishlist" data-id="<?php echo esc_attr($met); ?>" href="javascript:;"><?php esc_html_e('Delete', 'furniture'); ?></a>
										</td>
									</tr>
								</tbody>
							<?php endforeach; ?>
				...
				<?php else: ?>
					...
					<h2><?php printf(__('To view this page sign in at <a href="%s" title="Account Page">Account Page</a>', 'furniture'), $acc_page); ?></h2>
				<?php endif; ?>
