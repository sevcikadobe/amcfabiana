<div class="blog-box clearfix">
    ...
    <div class="meta">
        ...
        <span><a href="<?php echo get_author_posts_url( get_the_author_meta('ID') ); ?>" title="<?php the_author_meta( 'display_name' ); ?>"><?php esc_html_e('by : ' , 'furniture'); ?><?php the_author(); ?></a></span>
        <span><?php esc_html_e('in : ' , 'furniture'); ?><?php the_category(', '); ?></span>
    ...
    <div class="desc">
        <p> <?php the_excerpt(); ?> </p>
        <a href="<?php the_permalink(); ?>" class="readmore" title="<?php the_title_attribute(); ?>"><?php esc_html_e('Read More' , 'furniture'); ?><i class="icon-angle-double-right"></i></a>
    </div><!-- end desc -->
</div><!-- end blog-wrap -->