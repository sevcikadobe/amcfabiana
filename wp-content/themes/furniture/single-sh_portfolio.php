                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-title">
                            ...
                            <h3><span class="divider"></span> <?php esc_html_e('Description', 'furniture'); ?></h3>
                    ...
                    if( $services_section ): ?>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-title">
                                ...
                                <h3><span class="divider"></span> <?php esc_html_e('Whats New?', 'furniture'); ?></h3>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-title">
                            ...
                            <h3><span class="divider"></span> <?php echo sh_set( $meta, 'project_detail_title', esc_html__('Project Details', 'furniture') ); ?></h3>
                        ...
                        <?php echo get_the_term_list(get_the_id(), 'portfolio_category', '<p><strong>'.esc_html__('Category', 'furniture').':</strong> ', ', ', '</p>'); ?>
