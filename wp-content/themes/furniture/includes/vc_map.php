...
//Services
vc_map( array(
			"name" => __("bbPress Forums", 'furniture'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => __('Jollyall', 'furniture'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => __("Container", 'furniture'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => __("Choose whether you want to add a container before row or not.", 'furniture')
);
