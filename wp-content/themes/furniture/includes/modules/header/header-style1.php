			...
			<div class="col-sm-7 searchSec">
						...
						<div class="input-group">
							...
							<div class="input-group-btn searchFilters">
								<button type="button" class="btn  dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<span id="searchFilterValue"><?php esc_html_e('All Categories', 'furniture');?></span> <i class="fa fa-angle-down"></i>
								</button>
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu" id="_search_terms">
										<li><a href="#all"><?php esc_html_e('All Categories', 'furniture');?></a></li>
				...
				<div class="fleft wishlistCompare">
					<ul class="nav">
						<?php if( ($wishlist_page = sh_set( $options, 'wishlist_page' )) && is_user_logged_in() ): 
							...
							<li><a href="<?php echo get_permalink( $wishlist_page ); ?>"><i class="fa fa-heart"></i> <?php esc_html_e('Wishlist ', 'furniture');?>(<?php echo esc_attr(count(array_filter($meta))); ?>)</a></li>
						<?php endif; ?>
						<?php if( ($compare_page = sh_set( $options, 'compare_page' )) && is_user_logged_in() ): 
							...
							<li><a href="<?php echo get_permalink( $compare_page ); ?>"><i class="fa fa-exchange"></i> <?php esc_html_e('Compare ', 'furniture');?> (<?php echo esc_attr(count(array_filter($meta))); ?>)</a></li>
						<?php endif; ?>	
					</ul>
				</div>
				<?php if(sh_set($options, 'shopping_cart_icon')):?>
					...
					<?php if( function_exists( 'WC' ) ): 
                        ...
                        <?php include( _WSH()->includes('includes/modules/header/user_controls.php') ); ?>
	...
	<div class="container-fluid container">
		...
		<div class="navbar-header">
			<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#mainNav">
				<i class="fa fa-bars"></i><?php esc_html_e('Navigation', 'furniture');?>
			</button>
		</div>
