		...
		<div class="col-sm-5 menu2">
			<ul class="nav fright">
				<?php if( $myaccount_page = sh_set( $options, 'myaccount_page' ) ): ?>
					<li><a href="<?php echo get_permalink( $myaccount_page ); ?>"><?php esc_html_e('My Account', 'furniture');?></a></li>
				<?php endif;?>
				<?php if( $checkout_page = sh_set( $options, 'checkout_page' ) ): ?>
					<li><a href="<?php echo get_permalink( $checkout_page ); ?>"><?php esc_html_e('Checkout', 'furniture');?></a></li>
				<?php endif;?>
	...
	<div class="container">
		<form action="<?php echo home_url(); ?>" method="get" role="form" class="">
			<div class="input-group">
				<input type="search" name="s" placeholder="<?php esc_html_e('Search',  'furniture'); ?>" class="form-control" value="<?php echo get_search_query(); ?>">
